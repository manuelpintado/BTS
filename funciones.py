...
# -- --------------------------------------------------------- FUNCION: Bandas de Bollinger -- #


def Bollinger_Bands(df, window, ticker):
    """
    :param df: Data Frame de los datos a calcular
    :param window: Ventana de promedio movil
    :param ticker: Activo a graficar
    :return: DataFrame con bandas de bollinger y grafica
    """
